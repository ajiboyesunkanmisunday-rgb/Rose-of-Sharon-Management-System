...
export default function NewConvertTestPage() {
  ...
  const inputCls = "w-full rounded-lg border border-[#E5E7EB] px-3 py-2.5 text-sm text-[#111827] outline-none focus:border-green-400 focus:ring-1 focus:ring-green-400";
    ...
    <DashboardLayout>
      <div className="mb-6 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-[#6B7280]">Simulates a new convert filling the welcome card / public registration form</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-3">
        <div className="lg:col-span-2">
          <div className="rounded-xl border border-[#E5E7EB] bg-white p-6">
            ...
            <h2 className="mb-1 text-base font-bold text-[#111827]">Welcome to the Family!</h2>
            <p className="mb-5 text-xs text-[#6B7280]">Please fill in your details so we can stay in touch.</p>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div className="sm:col-span-2">
                <label className="mb-1 block text-xs font-semibold text-[#374151]">Street Address</label>
                <input value={street} onChange={(e) => setStreet(e.target.value)} placeholder="House number and street name" className={inputCls} />
              </div>
              <div>
                <label className="mb-1 block text-xs font-semibold text-[#374151]">City</label>
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-xl border border-[#E5E7EB] bg-white p-4">
            ...
            {history.length === 0 ? <p className="text-xs text-[#9CA3AF]">No registrations yet.</p> : (
