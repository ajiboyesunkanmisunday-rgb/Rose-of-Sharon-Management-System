...
export default function FirstTimersPage() {
  ...
  const filteredTimers = useMemo(() => {
    if (!search.trim()) return firstTimers;
          ...
          <tbody>
            {paginatedTimers.map((ft) => (
              ...
              >
                ...
                <td className="px-4 py-3 text-sm text-[#374151]">{ft.email}</td>
                ...
                <td className="px-4 py-3 text-sm text-[#374151]">{ft.date}</td>
                <td className="px-4 py-3 text-sm text-[#374151]">{ft.calls}</td>
                <td className="px-4 py-3 text-sm text-[#374151]">{ft.visits}</td>
                <td className="px-4 py-3">
                  <ActionDropdown
                    actions={[
                      {
