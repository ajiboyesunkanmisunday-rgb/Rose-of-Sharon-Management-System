  ...
  return (
    <DashboardLayout>
      ...
      <div className="mb-6 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-[28px] font-bold text-[#000000] dark:text-slate-100">My Profile</h1>
          <p className="text-sm text-[#6B7280] dark:text-slate-400">View and update your personal information</p>
        </div>
      </div>
      ...
      <div className="mb-6 rounded-xl border border-[#E5E7EB] dark:border-slate-700 bg-white dark:bg-slate-800 p-6">
        <div className="flex flex-col items-center gap-6 sm:flex-row sm:items-start">
          ...
          <div className="relative shrink-0">
            {profile?.profilePictureUrl ? (
              ...
              <div className="flex h-24 w-24 items-center justify-center rounded-full bg-[#B5B5F3] ring-4 ring-[#E5E7EB]">
                <span className="text-2xl font-bold text-[#000080] dark:text-indigo-400">{initials}</span>
              </div>
            )}
          ...
          <div className="hidden shrink-0 flex-col items-end gap-1 text-right sm:flex">
            {profile?.createdOn && (
              <span className="flex items-center gap-1.5 text-xs text-[#6B7280] dark:text-slate-400">
      ...
      <form onSubmit={handleSave}>
        <div className="mb-6 rounded-xl border border-[#E5E7EB] dark:border-slate-700 bg-white dark:bg-slate-800 p-6">
          <h3 className="mb-5 text-base font-bold text-[#111827] dark:text-slate-100">Personal Information</h3>
          ...
          <div className="grid grid-cols-1 gap-x-6 gap-y-4 md:grid-cols-2">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 rounded-lg border border-[#E5E7EB] dark:border-slate-700 px-4 py-3 text-sm text-[#9CA3AF] dark:text-slate-400">
                <Mail className="h-4 w-4 shrink-0" />
                <span>{email || "—"}</span>
              </div>
              <p className="mt-1 text-xs text-[#9CA3AF] dark:text-slate-400">Email cannot be changed here</p>
            </div>
            <PhoneInput
              label="Phone Number"
              code={countryCode}
            ...
            <div>
              ...
              <div className="relative">
                <Briefcase className="pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-[#9CA3AF] dark:text-slate-400" />
                <input
                  type="text"
                  value={occupation}
            ...
            <div>
              ...
              <div className="relative">
                <Heart className="pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-[#9CA3AF] dark:text-slate-400" />
                <select
                  value={maritalStatus}
            ...
            {(profile?.street || profile?.city || profile?.state) && (
              <div className="md:col-span-2">
                ...
                <div className="flex items-center gap-2 rounded-lg border border-[#E5E7EB] dark:border-slate-700 px-4 py-3 text-sm text-[#374151] dark:text-slate-300">
                  <MapPin className="h-4 w-4 shrink-0 text-[#9CA3AF] dark:text-slate-400" />
                  <span>
          ...
          <div
            className={`mb-4 rounded-lg border px-4 py-3 text-sm ${
              saveMsg.includes("success")
                ...
                : "border-red-200 bg-red-50 dark:bg-red-900/20 text-red-700"
            }`}
          >
            {saveMsg}
          </div>
      ...
      <div className="mt-6 rounded-xl border border-[#E5E7EB] dark:border-slate-700 bg-white dark:bg-slate-800 p-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-sm font-bold text-[#111827] dark:text-slate-100">Password</h3>
              <p className="text-xs text-[#6B7280] dark:text-slate-400">Update your account password</p>
            </div>
          </div>
          <Button
            variant="secondary"
        ...
        {showPwChange && (
          <form onSubmit={handleChangePassword} className="mt-5 space-y-4 border-t border-[#E5E7EB] dark:border-slate-700 pt-5">
            <div>
