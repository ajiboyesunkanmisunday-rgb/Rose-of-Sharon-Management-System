    ...
    <DashboardLayout>
      ...
      <div className="mb-6">
        ...
        <div className="mt-1 flex items-center gap-3">
          <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-[#EDE9FE] dark:bg-purple-900/30">
            <Flame className="h-5 w-5 text-[#7C3AED] dark:text-purple-400" />
          </div>
          <div>
            <h2 className="text-[20px] font-bold text-[#000080] dark:text-indigo-400">Prayer Request Workflow</h2>
            {!loading && (
      ...
      {loading ? (
        <div className="flex h-64 items-center justify-center">
          <div className="flex flex-col items-center gap-3 text-[#6B7280] dark:text-slate-400">
            <Flame className="h-8 w-8 animate-pulse text-[#7C3AED] dark:text-purple-400" />
