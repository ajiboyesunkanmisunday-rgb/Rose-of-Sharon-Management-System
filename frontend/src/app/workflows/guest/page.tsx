...
import KanbanBoard, { GUEST_COLUMNS } from "@/components/workflows/KanbanBoard";
import { getGuestWorkflow, type BoardColumn } from "@/lib/api";
          ...
          <div>
            ...
            {!loading && (
              <p className="text-xs text-[#6B7280]">
                {totalCount} active guest{totalCount !== 1 ? "s" : ""} · Drag cards between columns to update status
              </p>
            )}
          </div>
        </div>
