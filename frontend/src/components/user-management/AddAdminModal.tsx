        ...
        {!selectedUser ? (
          <div>
            ...
            {searchResults.length > 0 && (
              <div className="mt-2 max-h-48 overflow-y-auto rounded-lg border border-[#E5E7EB] dark:border-slate-700 bg-white dark:bg-slate-800 shadow-sm">
                {searchResults.map((u) => (
                  <button
                    key={u.id}
                    onClick={() => {
                    ...
                    className="flex w-full items-center gap-3 px-4 py-2 hover:bg-gray-50 dark:hover:bg-slate-700/50 dark:bg-slate-700/50 transition-colors text-left"
                  >
                    <div className="flex h-8 w-8 items-center justify-center rounded-full bg-gray-100 dark:bg-slate-700 text-xs font-bold text-gray-600 dark:text-slate-400">
                      {u.firstName[0]}
                      {u.lastName[0]}
                    </div>
          ...
          <div className="rounded-lg border border-[#E5E7EB] dark:border-slate-700 bg-[#F9FAFB] p-3 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-[#6B7280] dark:text-slate-400">{selectedUser.email}</p>
              </div>
            </div>
            <button
              onClick={() => setSelectedUser(null)}
              className="p-1 hover:bg-gray-200 dark:bg-slate-600 rounded-full transition-colors"
            >
